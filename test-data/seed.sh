...
#   ADMIN=devtoken ./test-data/seed.sh                   # in another
#
# Environment:
...
# fresh set of consumer tokens and writes them to test-data/tokens.env.
set -euo pipefail
...

{
  ...
  echo "# source this file: . test-data/tokens.env"
